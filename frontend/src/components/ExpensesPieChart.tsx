...
//                 color: '#fff',
//                 font: (context: any) => {
//                     const textLength = context.chart.data.labels[context.dataIndex].length;
//                     return {
//                         size: textLength > 10 ? 10 : 12, // גודל דינמי לפי אורך הטקסט
//                         family: 'Arial, sans-serif',
//                     };
//                 },
...
//                     return `${category}\n${percentage}%`;
//                 },
//                 anchor: 'center', // מרכז הטקסט
//                 align: 'center', // מיקום בתוך הסגמנט
//                 clip: true, // מניעת יציאה מהגרף
//                 clamp: true, // מניעת יציאה מהגבולות
//                 textAlign: t.isRTL ? 'right' : 'center', // יישור טקסט לפי שפה
//             },
//         },
//         layout: {
//             padding: 20,
